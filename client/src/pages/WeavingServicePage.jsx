...
export default function WeavingServicePage() {
  ...
  const clothTypes = [
    { name: 'Cotton', slug: 'cotton', servicePerMetre: 180 },
    { name: 'Rayon', slug: 'rayon', servicePerMetre: 210 },
    { name: 'Polyester', slug: 'polyester', servicePerMetre: 160 },
    { name: 'Silk', slug: 'silk', servicePerMetre: 280 },
    { name: 'Woollen', slug: 'woollen', servicePerMetre: 240 },
    { name: 'Linen', slug: 'linen', servicePerMetre: 250 },
    { name: 'Nylon', slug: 'nylon', servicePerMetre: 150 },
    { name: 'Acrylic', slug: 'acrylic', servicePerMetre: 140 }
  ];
  ...
  const cloth = clothTypes.find((c) => c.slug === 'cotton') || clothTypes[0];
  ...
  const servicePerMetre = cloth.servicePerMetre;
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-100">
      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <div className="absolute top-8 right-8 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-2xl shadow-xl">
          <div className="text-xs text-gray-600 mb-1">Weaving Service</div>
          <div className="text-lg font-bold text-emerald-600">Professional Service</div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12">
          <div className="container mx-auto">
            <div className="max-w-4xl">
              ...
              <h1 className="text-3xl md:text-4xl font-extrabold text-white drop-shadow-2xl">{clothName} Weaving Service</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-emerald-100 -mt-32 relative z-10">
            <div className="p-12">
              ...
              <div className="bg-white/60 rounded-xl p-4 mb-8 border border-emerald-200">
                <h3 className="text-lg font-bold text-emerald-900 mb-3">Service Pricing</h3>
                <p className="text-2xl font-bold text-emerald-600 mb-4">₹{servicePerMetre}/metre</p>
                <div className="bg-white/60 rounded-xl p-4 mb-4">
                  <p className="text-sm text-gray-700"><strong>Example Costs:</strong></p>
                  <ul className="text-sm text-gray-600 mt-2 space-y-1">
                    <li>• 10 metre: ₹{servicePerMetre * 10}</li>
                    <li>• 50 metre: ₹{servicePerMetre * 50}</li>
                    <li>• 100 metre: ₹{servicePerMetre * 100}</li>
                  </ul>
                </div>
              </div>
              ...
              {/* Description */}
              <div className="mb-10">
                <h2 className="text-xl font-bold text-gray-800 mb-4">Service Overview</h2>
                <p className="text-gray-700 leading-relaxed text-sm">
                  Our professional weaving service for {clothName.toLowerCase()} provides excellent quality fabric production 
                  with affordable rates. We use state-of-the-art automated looms to ensure consistency and superior finish. 
                  Our experienced team handles every aspect of the weaving process to deliver fabric that meets your exact specifications.
                </p>
              </div>

              {/* Features */}
              <div className="mb-10">
                <h3 className="text-lg font-bold text-gray-800 mb-6">Service Features</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    'Professional weaving service',
              ...
              <div className="border-t border-gray-200 pt-10">
                <h3 className="text-lg font-bold text-gray-800 mb-6">Ready to Book Our Service?</h3>
                <p className="text-gray-700 text-sm mb-8">Book our {clothName.toLowerCase()} weaving service today and get professional quality fabric processing at competitive rates.</p>
