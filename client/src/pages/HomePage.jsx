    ...
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-rose-200 selection:text-rose-900 overflow-x-hidden">
      ...
      <section className="relative min-h-[92vh] flex flex-col justify-center items-center text-center px-4 pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto space-y-8">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-md border border-white/50 shadow-sm mb-4 animate-fade-in-up">
            <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
            <span className="text-sm font-medium text-slate-600 tracking-wide uppercase">Leading Textile Innovation</span>
          </div>

          {/* Headline */}
          <h1 className="text-6xl md:text-8xl font-serif text-slate-800 tracking-tight leading-[1] drop-shadow-sm animate-fade-in-up delay-100">
            Weaving <span className="italic text-indigo-500">Excellence</span> into <br /> Every Thread.
          </h1>

          <p className="text-xl md:text-2xl text-slate-500 max-w-2xl mx-auto font-light leading-relaxed animate-fade-in-up delay-200">
            Premium sizing and weaving solutions that define quality. <br className="hidden md:block" /> transforming raw materials into textile masterpieces.
          </p>
