    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-blue-100">
      ...
      <div className="relative overflow-hidden py-20 px-4">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="inline-block p-4 bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl shadow-2xl mb-6">
            <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          </div>
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-600 to-blue-600">
            Get in Touch
          </h1>
      ...
      <div className="container mx-auto px-4 pb-20">
        ...
        <div className="max-w-4xl mx-auto bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-cyan-100">
          <div className="p-10">
            {user ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-bold mb-3 text-gray-700">Phone Number <span className="text-gray-400 font-normal">(Optional)</span></label>
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {user && (
        <div className="container mx-auto px-4 mt-10 pb-20">
          <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-cyan-100">
                ...
                <div className="space-y-4">
                  {messages.map((m) => (
                    <div 
                      key={m._id} 
                      id={`msg-${m._id}`}
                      className={`bg-gradient-to-br from-cyan-50 to-blue-50 border-2 rounded-2xl p-6 hover:shadow-lg transition-all ${
                        highlightedMessageId === m._id 
                          ? 'border-blue-500 shadow-2xl ring-2 ring-blue-300' 
                          : 'border-cyan-200'
                      }`}
                    >
