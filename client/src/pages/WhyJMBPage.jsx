export default function WhyChinnuTexPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-100">
      ...
      <div className="relative overflow-hidden py-24 px-4">
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="inline-block p-5 bg-gradient-to-br from-purple-500 to-blue-600 rounded-full shadow-2xl mb-6">
            <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
            </svg>
          </div>
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">
      ...
      <div className="container mx-auto px-4 pb-20">
        <div className="max-w-7xl mx-auto space-y-10">
          {/* Savings Section */}
          <section id="savings" className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-amber-100">
              ...
              <div className="p-12">
                ...
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-800 flex-1">Shorter cycle times through tuned bleaching curves</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-6 h-6 bg-amber-500 rounded-full flex items-center justify-center mt-1">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="/why-chinnu-tex/savings" className="inline-block px-8 py-3 bg-gradient-to-r from-amber-500 to-orange-600 text-white rounded-xl font-bold hover:shadow-xl transition-all">
          ...
          <section id="sustainability" className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-emerald-100">
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-12 order-1 lg:order-2">
                ...
                <a href="/why-chinnu-tex/sustainability" className="inline-block px-8 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl font-bold hover:shadow-xl transition-all">
